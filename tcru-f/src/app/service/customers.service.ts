...
export class CustomersService {
  ...
  //   return this.http.post(environment.apiBaseUrl + '/create', customer);
  // }
  showCustomer() {
    ...
    getData1(data)
    {
     return this.http.post('http://localhost:5000/api/Customers2',data);
    }
    deleteCustomers(id) {
      return this.http.delete('http://localhost:5000/api/deleteCustomers/'+id);
    }
    geteditCustomers(id){
      return this.http.get('http://localhost:5000/api/getCustomers1/'+id);
     }
  
     editCustomers(id,data)
     {
      return this.http.patch('http://localhost:5000/api/updateCustomers/'+id,data);
     }
}
